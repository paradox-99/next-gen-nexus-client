...
const Register = () => {
    ...
    return (
        <div className="w-full flex justify-center items-center mt-64 md:mt-32 xl:mt-6">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="w-full" noValidate>
                        ...
                        >
                            <div className="flex flex-col">
                                ...
                                <p className="font-poppins text-lg mt-3 text-center">Already have an account. <Link to={'/signin'} className="text-blue-800 hover:underline">Log in</Link></p>
